...
function invIP(s0: number, s1: number): Uint8Array {
  ...
  out[3] = (g(s1, 7) << 7) | (g(s0, 7) << 6) | (g(s1, 15) << 5) | (g(s0, 15) << 4) | (g(s1, 23) << 3) | (g(s0, 23) << 2) | (g(s1, 31) << 1) | g(s0, 31)
  out[2] = (g(s1, 6) << 7) | (g(s0, 6) << 6) | (g(s1, 14) << 5) | (g(s0, 14) << 4) | (g(s1, 22) << 3) | (g(s0, 22) << 2) | (g(s1, 30) << 1) | g(s0, 30)
  out[1] = (g(s1, 5) << 7) | (g(s0, 5) << 6) | (g(s1, 13) << 5) | (g(s0, 13) << 4) | (g(s1, 21) << 3) | (g(s0, 21) << 2) | (g(s1, 29) << 1) | g(s0, 29)
  out[0] = (g(s1, 4) << 7) | (g(s0, 4) << 6) | (g(s1, 12) << 5) | (g(s0, 12) << 4) | (g(s1, 20) << 3) | (g(s0, 20) << 2) | (g(s1, 28) << 1) | g(s0, 28)
  out[7] = (g(s1, 3) << 7) | (g(s0, 3) << 6) | (g(s1, 11) << 5) | (g(s0, 11) << 4) | (g(s1, 19) << 3) | (g(s0, 19) << 2) | (g(s1, 27) << 1) | g(s0, 27)
  out[6] = (g(s1, 2) << 7) | (g(s0, 2) << 6) | (g(s1, 10) << 5) | (g(s0, 10) << 4) | (g(s1, 18) << 3) | (g(s0, 18) << 2) | (g(s1, 26) << 1) | g(s0, 26)
  out[5] = (g(s1, 1) << 7) | (g(s0, 1) << 6) | (g(s1, 9) << 5) | (g(s0, 9) << 4) | (g(s1, 17) << 3) | (g(s0, 17) << 2) | (g(s1, 25) << 1) | g(s0, 25)
  out[4] = (g(s1, 0) << 7) | (g(s0, 0) << 6) | (g(s1, 8) << 5) | (g(s0, 8) << 4) | (g(s1, 16) << 3) | (g(s0, 16) << 2) | (g(s1, 24) << 1) | g(s0, 24)
  return out
}
...
export function decryptQrc(encryptedHex: string): string | null {
  try {
    ...
    for (let i = 0; i < encrypted.length; i += 8) {
      const block = tripleDESCrypt(
        Uint8Array.from(encrypted.subarray(i, i + 8)),
        schedule,
      )
