  ...
  'inline-flex shrink-0 items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors outline-none disabled:pointer-events-none disabled:opacity-45 focus-visible:ring-2 focus-visible:ring-ring [&_svg]:pointer-events-none [&_svg]:size-4',
  {
    variants: {
      variant: {
        ...
        glassSoft: [
          'border border-[var(--flux-glass-border)] bg-[color-mix(in_srgb,var(--flux-panel-border)_8%,transparent)]',
          'text-[var(--flux-text)] [font-family:var(--flux-font-family)]',
        ...
        glassRaised: [
          'cursor-pointer border border-[color-mix(in_srgb,var(--flux-panel-border)_10%,transparent)]',
          'bg-[color-mix(in_srgb,var(--flux-panel-surface)_74%,transparent)]',
          'text-[var(--flux-text)] [font-family:var(--flux-font-family)]',
